public class Wordle {
    ...
    public static void main(String[] args) {
        ...
        char[][] guesses = new char[WORD_LENGTH][MAX_ATTEMPTS] ;
        char[][] results = new char[WORD_LENGTH][MAX_ATTEMPTS] ;
        ...
        if (!won) {
           System.out.println("Sorry, you didn't guess the word. The secret word was: " + secret);
        }
